...
const mockBooks: GoogleBookVolumes[] = [
  {
    ...
    volumeInfo: {
      ...
      description:
        'Learn how to write code that is readable and maintainable.',
      industryIdentifiers: [],
      ...
      canonicalVolumeLink:
        'https://play.google.com/store/books/details?id=book-1',
    },
    saleInfo: {
      country: 'BR',
  ...
  },
  {
    ...
    volumeInfo: {
      ...
      imageLinks: {
        smallThumbnail:
          'https://covers.openlibrary.org/b/id/8236019-S.jpg',
        thumbnail:
          'https://covers.openlibrary.org/b/id/8236019-M.jpg',
      },
      language: 'en',
      previewLink: 'http://books.google.com/books?id=book-2',
      infoLink: 'https://play.google.com/store/books/details?id=book-2',
      canonicalVolumeLink:
        'https://play.google.com/store/books/details?id=book-2',
    },
    saleInfo: {
      country: 'BR',
      saleability: 'FOR_SALE',
